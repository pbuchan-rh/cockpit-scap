...
test.describe('Policy Tailoring', () => {
    ...
    test('load profile into editor', async ({ page }) => {
        ...
        await expect(frame.locator('#ct-tailor-rules-collapse')).toBeVisible({ timeout: 10000 });
    ...
    test('disable a rule and save', async ({ page }) => {
        ...
        // Expand rules section then expand all groups so checkboxes are interactable
        await frame.locator('#ct-tailor-rules-header').click();
